...
namespace Bookstore.Web.Controllers
{
    public class AddressController : Controller
    {
        ...
        {
            return View("CreateUpdate", new AddressCreateUpdateViewModel(returnUrl));
        }
        ...
        public async Task<IActionResult> Create(AddressCreateUpdateViewModel model)
        {
            ...
            var dto = new CreateAddressDto(model.AddressLine1, model.AddressLine2, model.City,
                model.State, model.Country, model.ZipCode, User.GetSub());
        ...
        public async Task<IActionResult> Update(AddressCreateUpdateViewModel model)
        {
            ...
            var dto = new UpdateAddressDto(model.Id, model.AddressLine1, model.AddressLine2,
                model.City, model.State, model.Country, model.ZipCode, User.GetSub());
        ...
        {
            await addressService.DeleteAddressAsync(new DeleteAddressDto(id, User.GetSub()));
