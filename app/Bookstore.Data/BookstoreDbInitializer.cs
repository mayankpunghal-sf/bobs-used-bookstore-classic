...
{
    /// <summary>
    /// Seeds the database with initial reference and book data if the tables are empty.
    /// Called from Program.cs on startup (replaces EF6 DropCreateDatabaseIfModelChanges initialiser).
    /// </summary>
    public static class BookstoreDbInitializer
    {
        public static async Task SeedAsync(ApplicationDbContext context)
        {
            ...
            if (await context.ReferenceData.AnyAsync()) return;
            ...
            var books = new List<Book>
            {
                ...
                new Book("Leagues Of Smoke",         "Pat Candella",  "4556789542", 18, 2, 11, 7,  3.00M,  1, null, null, "/Content/Images/coverimages/leaguesofsmoke.png")   { Id = 4 },
                ...
                new Book("My Search For Meaning",    "Mateo Jackson", "4558786554", 22, 3,  8, 7,  5.00M, 15, null, null, "/Content/Images/coverimages/mysearchformeaning.png"){ Id = 8 },
            };
